...
* ProfessionalEngineeringCore.
  ...
  * Transformer impedance is manufacturer/nameplate data.
  
  * 
  
  * 0.0 means that no verified impedance value has been supplied.
  
  * 
  
  * IMPORTANT:
  
  * Never replace missing transformer impedance with an assumed
  
  * engineering value such as 6%.
    */
    fun setTransformer(
  ...
  * Stores verified transformer impedance.
  
  * 
  
  * A value of 0.0 means unavailable/not supplied.
    */
